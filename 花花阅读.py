...
time: 2023。7.28
new Env('花花阅读');
地址：http://mr1691470027604.ottgdhl.cn/user/index.html?mid=5Q85LET4M 【花花阅读】看文章赚零花钱，全新玩法，提现秒到(若链接打不开，可复制到手机浏览器里打开) 【花花阅读】看文章赚零花钱，全新玩法，提现秒到(若链接打不开，可复制到手机浏览器里打开)
复制微信打开。【花花阅读】看文章赚零花钱，全新玩法，提现秒到(若链接打不开，可复制到手机浏览器里打开)
进入app-我的-抢红包或者在我的钱包-提现进去之后抓包
提前在我的钱包里面绑定zfb号
抓包域名: http://u.cocozx.cn
抓包请求体里面: un和token（注:每次运行脚本前先手动获取一次阅读文章，然后再运行本脚本，否则文章会失效）
